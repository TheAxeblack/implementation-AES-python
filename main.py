...
key2: list[Byte] = [0xa0, 0xfa, 0xfe, 0x17, 0x88, 0x54, 0x2c, 0xb1, 0x23, 0xa3, 0x39, 0x39, 0x2a, 0x6c, 0x76, 0x05]
...
if __name__ == "__main__":
    ...
    for i in range(NR + 1):
        ...
        print(f"Round {i} Key: " + " ".join(f"0x{byte:02X}" for byte in round_key))
